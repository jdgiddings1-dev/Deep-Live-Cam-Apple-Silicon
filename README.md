...
> Note: The old `onnxruntime-silicon` package is deprecated. The official
> `onnxruntime` wheel now ships native arm64 macOS binaries with CoreML
> (MLProgram / Neural Engine) support, which this project requires.
